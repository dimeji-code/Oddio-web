...
const Cart = () => {
  ...
  return (
    <div className='px-5 md:px-[10%] pt-[10vh] flex flex-col h-full items-center'>
      <ToastContainer  />
        <h4 className='font-semibold text-xl md:text-2xl py-2 md:py-4'>Cart Items</h4>
        <h4 className='text-sm md:text-base subpixel-antialiased font-light md:font-normal mb-2 '>Total Items: {localNumber}</h4>
        <h4 className='hidden md:flex text-sm md:text-base subpixel-antialiased font-light md:font-normal mb-2 '>Total Amount: ${(localAmount?.toFixed(2)) }</h4>

    {itemArray.length > 0  && 
    <>
        <button 
          className='font-light text-md border-[1.1px]  border-black hover:border-gray-500 duration-700 hover:bg-gray-500 hover:text-white rounded-sm p-1 md:p-2' 
          onClick={clear}>
            clear cart
        </button>
      ...
      <div className='flex flex-col md:flex-row w-full '>
        ...
        <div className='w-full md:w-4/5 flex flex-col mt-2 h-[40vh] md:h-[70vh] overflow-y-scroll'>{ itemArray}</div>
        {/* <div className='w-[30%] md:w-1/5 m-2 '>  */}
        <div className=' w-1/2  md:w-1/5 m-2 '> 
            <div className='border shadow-sm bg-slate-50 w-full p-2 m-2'>
              ...
              <button 
                className='font-light text-base border-[1.1px] border-black hover:border-[#519e59] duration-700 hover:bg-[#519e59] hover:text-white rounded-sm p-1 md:p-2' 
